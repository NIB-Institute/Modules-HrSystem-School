...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: t('Trash'), href: '/dashboard/courses/trash' },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="t('Courses Trash')" />

        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">{{ t('Courses Trash') }}</h1>
                    <p class="text-sm text-muted-foreground">
                        {{ t('Manage deleted courses - restore or permanently delete') }}
                    </p>
                </div>
                <ButtonGroup>
            ...
            <TrashTable
                ...
                :selectable="true"
                select-key="uuid"
                :empty-message="t('No deleted courses found.')"
