...
const columns: TableColumn<Course>[] = [
    ...
    },
    {
        key: 'status',
        label: t('Status'),
        render: (course) => course.status ? t('Active') : t('Inactive'),
    },
];
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-lg font-semibold">{{ t('Courses') }}</h2>
                        <p class="text-sm text-muted-foreground">{{ t('Manage courses and curricula') }}</p>
                    </div>
                ...
                >
                    ...
                    <template #cell-credits="{ item }">
                        <Badge variant="secondary">{{ item.credits }} {{ t('Credits') }}</Badge>
                    </template>
