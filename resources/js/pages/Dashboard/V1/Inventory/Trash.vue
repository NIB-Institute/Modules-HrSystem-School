...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Trash', href: '/dashboard/inventories/trash' },
];

const trashConfig: TrashConfigLocal = {
    entityLabel: 'Inventory item',
    entityLabelPlural: 'Inventory',
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Inventory Trash" />

        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">Inventory Trash</h1>
                    <p class="text-sm text-muted-foreground">
                        Manage deleted inventory items — restore or permanently delete
                    </p>
                </div>
                <ButtonGroup>
            ...
            <TrashTable
                ...
                :selectable="true"
                select-key="uuid"
                empty-message="No deleted inventory items found."
